      ...
      <div className="contact__container container grid">
        <div className="contact__data">
          ...
          <div className="contact__info">
            <div className="info__item">
              ...
              <div>
                ...
                <h4 className="info__desc">thomasngangagithuku@gmail.com</h4>
              </div>
            </div>
            ...
            <div className="info__item">
              ...
              <div>
                ...
                <h4 className="info__desc">+254 708 366 961</h4>
              </div>
            </div>
          </div>
          ...
          <div className="contact__socials">
            ...
            <a href="http://dribbbler.com" className="contact__social-link">
              <FaDribbble />
            </a>
          </div>
        </div>
        ...
        <form className="contact__form">
          ...
          <div className="form__input-div">
            <textarea className="form__control textarea"></textarea>
          </div>
